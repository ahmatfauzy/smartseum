    ...
    <nav className="w-full relative z-50 bg-transparent transition-colors">
      <div className="px-4 md:px-12 lg:px-24">
        <div className="flex items-center justify-between py-4 sm:py-6">
          {/* Logo / Brand */}
          <h2 className="text-2xl font-medium text-black dark:text-white">SmartSeum</h2>
      ...
      <div
        className={`md:hidden absolute top-full left-0 right-0 w-full bg-white/90 dark:bg-black/90 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800 shadow-lg transition-all duration-300 origin-top overflow-hidden z-10 ${
          isActive ? "max-h-[500px] opacity-100 py-4" : "max-h-0 opacity-0"
        }`}
      >
        <div className="flex flex-col gap-2 px-4">
          <button className="w-full text-left px-4 py-3 text-base font-medium rounded-lg bg-gray-100 dark:bg-gray-800 text-black dark:text-white transition-colors">
            HOME
          </button>
