...
const FEATURES = [
  {
    ...
    description: "Nikmati pengalaman AR langsung melalui browser smartphone Anda tanpa perlu mengunduh aplikasi tambahan.",
  ...
  },
  {
    ...
    description: "Setiap artefak didigitalisasi dengan detail ultra-presisi untuk memberikan visualisasi yang mendekati aslinya.",
  ...
  },
  {
    ...
    description: "Cukup arahkan kamera ke QR Code di samping pajangan untuk membuka informasi mendalam secara otomatis.",
    color: "text-cyan-500",
    bg: "bg-cyan-500/10",
  },
  {
    ...
    description: "Data koleksi terhubung langsung dengan sistem admin museum untuk pembaruan informasi yang instan.",
  ...
  },
  {
    ...
    description: "Pelajari sejarah, filosofi, dan asal-usul artefak melalui narasi tekstual yang komprehensif.",
    color: "text-rose-500",
    bg: "bg-rose-500/10",
  },
  {
    ...
    description: "Menjaga warisan budaya tetap abadi dalam format digital untuk generasi mendatang.",
    color: "text-blue-500",
    bg: "bg-blue-500/10",
  },
];
...
const FeatureSection = () => {
  return (
    <section className="w-full py-32 px-6 md:px-12 lg:px-24 bg-transparent transition-colors relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center space-y-4 mb-24 max-w-3xl">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-black dark:text-white leading-tight">
            Fitur Canggih Untuk <span className="text-emerald-500">Masa Depan</span> Museum.
          </h2>
          <p className="text-gray-500 dark:text-gray-400 text-lg font-light leading-relaxed pt-2">
            Kami menggabungkan seni dan teknologi untuk memberikan pengalaman yang tak terlupakan bagi setiap pengunjung.
          </p>
        </div>
          ...
          {FEATURES.map((feature, i) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute -top-12 -right-12 w-24 h-24 blur-3xl rounded-full opacity-0 group-hover:opacity-20 transition-opacity ${feature.bg}`} />
